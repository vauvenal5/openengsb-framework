...
public interface JPADao {
	...
	List<JPAStageObject> getStagedJPAObjectHistory(String oid, String sid) throws EDBException;
	...
	List<JPAStageObject> getStagedJPAObjectHistory(String oid, String sid, long from, long to) throws EDBException;
	...
	JPAStageObject getStagedJPAObject(String oid, String sid, long timestamp) throws EDBException;
	...
	JPAStageObject getStagedJPAObject(String oid, String sid) throws EDBException;
	...
	List<JPAStageObject> getStagedJPAObjects(List<String> oids, String sid) throws EDBException;
	...
	List<JPAStageCommit> getStagedJPACommit(long timestamp, String sid) throws EDBException;
	...
	List<JPAStageCommit> getStagedCommits(Map<String, Object> param, String sid) throws EDBException;
	...
	List<JPAStageObject> queryStaged(Map<String, Object> values, String sid) throws EDBException;
	...
	List<JPAStageObject> queryStaged(Map<String, Object> values, String sid, Long timestamp) throws EDBException;
